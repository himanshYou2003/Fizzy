...
export default function Scene({}: Props) {
    ...
    useGSAP(()=>{
        ...
        if(window.scrollY <20 ){
            ...
            introT1.from(can1GroupRef.current.position,{y : -5,x:1},0);
            introT1.from(can1GroupRef.current.rotation,{z:3},0);
            introT1.from(can2GroupRef.current.position,{y : 5,x:1},0);
            introT1.from(can2GroupRef.current.rotation,{z:3},0);
        ...
        //Rotate Can Groups
        scrollT1.to(groupRef.current.rotation,{ y :Math.PI *2})
        ...
        // Can 3 -Grape
        .to(can3Ref.current.position,{x:-0.3,y:0.2,z:-1},0)
        ...
        .to(can5Ref.current.rotation,{z:-0.23},0)
